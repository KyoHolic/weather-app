package at.technikum_wien.if20b049.step1.viewmodels
...
import at.technikum_wien.if20b049.step1.data.download.WeatherDownloader
...
class WeatherListViewModel() : ViewModel() {
    ...
    init {
        downloadNewsItems("https://api.openweathermap.org/data/2.5/forecast?q=Vienna,AT&appid=7776c10840f221b6c1ffb654afbaacc3")
    }
    ...
    @RequiresApi(Build.VERSION_CODES.O)
    private fun downloadNewsItems(weatherFeedUrl: String) {
        _error.value = false
