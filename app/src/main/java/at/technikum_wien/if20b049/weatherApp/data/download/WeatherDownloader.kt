package at.technikum_wien.if20b049.weatherApp.data.download
...
import at.technikum_wien.if20b049.weatherApp.data.parser.JsonParser
...
class WeatherDownloader {
    ...
    suspend fun loadWebResult(urlString: String): List<WeatherItem>? {
        ...
        if (result == null) {
           ...
           // resultTextView?.text = ""*/
            ...
            return withContext(Dispatchers.Default) {
                ...
                val idk = parser.parseResponse(result)
                idk
            }
        }
        return null
